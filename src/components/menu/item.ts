...
export class MenuItem extends LitElement {
  ...
  render() {
    ...
    const classList = classNames(
      'menu-item relative tracking-[0.05em] flex items-center justify-center h-10 xl:h-12 px-4 text-stone-950 dark:text-zinc-50 text-[.75rem] leading-none uppercase'
    )

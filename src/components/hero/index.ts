    ...
    return html`
      <section class="hero">
        <div class="min-h-[calc(100svh-4rem)] pt-12 gap-10 xl:gap-0 xl:pt-0 flex flex-col justify-center xl:justify-end container">
          <div class="px-5 xl:py-24 2xl:py-32 flex flex-col justify-end items-start gap-8">
            ...
            <h1 class="text-[2.5rem] leading-none xl:text-[3rem] 2xl:text-[4rem] tracking-[-0.04em] dark:text-zinc-200 text-stone-950 text-pretty">

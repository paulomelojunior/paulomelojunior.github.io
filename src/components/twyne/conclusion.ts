...
export class TwyneConclusion extends LitElement {
  ...
  private renderSignature(): unknown {
    return html`
      <svg 
        id="sign" 
        class="absolute bottom-2 stroke-brand-400 rotate-[21deg]" 
        width="44" 
        height="67" 
        viewBox="0 0 44 67" 
        fill="none" 
  ...
  private renderContent(): unknown {
    return html`
      <h2 class="uppercase leading-none mb-4 tracking-[0.05em] xl:text-[0.75rem] dark:text-zinc-500 font-semibold">

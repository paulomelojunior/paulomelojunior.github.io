    ...
    return html`
      <div class="h-px w-full bg-gradient-to-r from-transparent via-zinc-800 to-transparent"></div>
				<div class="flex relative xl:h-[512px] rounded-[2rem] bg-black">
					...
					<div class="flex-1 flex flex-col aspect-square gap-16 p-16 xl:p-28 justify-between items-center relative bg-zinc-400/10  xl:rounded-r-[2rem] backdrop-blur-lg">
